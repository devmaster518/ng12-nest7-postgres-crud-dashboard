...
export class AuthController {
  constructor(
    private readonly auth: AuthService // private readonly db: DatabaseService,
  ) {}

  @Post('createToken')
  async createToken(@Body() body: any): Promise<AuthToken> {
    return await this.auth.createToken(body.userCode, body.password);
  }
